...
public class Main {
    ...
    public void filterProductWithPrice(List<Product> products, double threshold) {
    ...
    public void findMaxInEachGroup(List<Product> products) {
    ...
    public void filterByTotalOrderValue(List<Order> orders, double minTotal) {
        orders.stream().filter(x -> x.orderItems().stream().map(Item::price).reduce(0.0,Double::sum) > minTotal).forEach(System.out::println);
    }

    public void groupByCustomerId(List<Order> orders, double minTotal) {
    ...
    public void findHighestOrderWithinGroup(List<Order> orders, double minTotal) {
    ...
    public void totalOrderValueForEachCustomer(List<Order> orders, double minTotal) {
    ...
    public void sortByOrderValue(List<Order> orders) {
